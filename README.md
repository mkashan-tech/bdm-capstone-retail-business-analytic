...
| Bad Debt (5 months)     | ₹40,184         | ~₹6,000               | **-85%**        |
| Cash-to-Credit Ratio    | 1.86 (Warning)  | >2.5 (Safe)           | Improving       |
| Additional Profit       | —               | ₹53,798+              | **+43.4%**      |

**Key Insight:** 98% of credit defaults originated from just 26.7% of customers. A risk-based credit policy eliminated the majority of the leak while preserving relationships with reliable customers.
...
This project was executed as an end-to-end independent consulting engagement:
...
3-phase implementation plan with projected ₹53,798+ additional profit (+43.4% growth).
...
### 2. Dynamic Credit Policy

```
Credit Limit = Reliability Score × 20
```

- Immediate freeze of credit for all 28 “Cash Only” customers → eliminates 72% of defaults  
...
- Goal: Eliminate majority of default exposure immediately

**Phase 2: Drive Profitability (Months 1–6)**  
- Roll out dynamic credit limits  
...
**Projected 5-Month Impact:** Net Profit ₹1,23,804 → ₹1,77,602 (+43.4%)
...
|-----------------------------|-------------------------------------------------------------|
| Primary Research            | Collected, digitized & validated 3 operational datasets     |
| Financial Analysis          | Waterfall P&L, liquidity ratios, margin analysis            |
...
| Stakeholder Communication   | Separate Academic & Stakeholder presentations               |
...
| Documentation| Proposal → Midterm → Final Report | Complete project lifecycle                 |
...
It is an **independent research project** requiring students to identify a real business, collect primary data, diagnose problems, and deliver actionable insights.
